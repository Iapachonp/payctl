...
func init() {
	...
	createPaymentscmd.PersistentFlags().String("name", "", "Name of the payment object to create.")
	createPaymentscmd.MarkFlagRequired("name")
	createPaymentscmd.PersistentFlags().String("cron", "", "Name of the payment object to create.")
	createPaymentscmd.MarkFlagRequired("cron")
	createPaymentscmd.PersistentFlags().String("description", "", "Description of the payment object to create.")
	createPaymentscmd.MarkFlagRequired("description")
	createPaymentscmd.PersistentFlags().String("url", "", "Name of the payment object to create.")
	createPaymentscmd.MarkFlagRequired("url")
	// createPaymentscmd.PersistentFlags().String("group", "", "Name of the payment object to create.")
	// createPaymentscmd.PersistentFlags().String("company", "", "Name of the payment object to create.")
	createPaymentscmd.PersistentFlags().Int("groupid", 0, "Name of the payment object to create.")
	createPaymentscmd.PersistentFlags().Int("companyid", 0, "Name of the payment object to create.")
}
